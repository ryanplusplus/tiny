...
### Flexible
`tiny` relies upon run-time polymorphism provided by low-cost interfaces. This allows for a roughly object-oriented style, but without inheritance. Interfaces make `tiny` flexible, portable, and testable.
